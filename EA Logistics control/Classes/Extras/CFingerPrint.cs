...
namespace ExtraFunctions
{
    ...
    public class CFingerPrint
    {
        ...
        /// <summary>
        /// Returns the physical address of machine based on first network interface found. Contains shorter code.
        /// </summary>
        /// <returns></returns>
        ...
        //    foreach (NetworkInterface niTest in ni)
        //    {
        //        PhyAdd = niTest.GetPhysicalAddress().ToString();
        //        break;
        //    }
        //    return PhyAdd;
